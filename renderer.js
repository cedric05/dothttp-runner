...
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);
/* harmony import */ var vscode_codicons_src_icons_save_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
/* harmony import */ var vscode_codicons_src_icons_save_svg__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(vscode_codicons_src_icons_save_svg__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var vscode_codicons_src_icons_search_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
/* harmony import */ var vscode_codicons_src_icons_search_svg__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(vscode_codicons_src_icons_search_svg__WEBPACK_IMPORTED_MODULE_3__);
...
const Response = ({ response, saveResponse }) => {
    var _a, _b;
        ...
        (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: 'tab-bar' },
            ...
            (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: 'tab-bar-tools' },
                ...
                (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("button", { id: searchButtonId, class: 'search-button', title: 'Search for keyword', onClick: () => handleSearchForKeywordClick(setSearchKeyword, searchBarId) },
                    (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(Icon, { name: vscode_codicons_src_icons_search_svg__WEBPACK_IMPORTED_MODULE_3__ })),
                (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("button", { class: 'save-button', title: 'Save response', onClick: () => saveResponse(response) },
                    (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(Icon, { name: vscode_codicons_src_icons_save_svg__WEBPACK_IMPORTED_MODULE_2__ }),
                    "Save Response"))),
        (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("br", null),
...
module.exports = "<svg viewBox=\"0 0 16 16\" xmlns=\"http://www.w3.org/2000/svg\" fill=\"currentColor\"><path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M13.353 1.146l1.5 1.5L15 3v11.5l-.5.5h-13l-.5-.5v-13l.5-.5H13l.353.146zM2 2v12h12V3.208L12.793 2H11v4H4V2H2zm6 0v3h2V2H8z\"></path></svg>"
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".tab-bar {\n    display: flex;\n    justify-content: space-between;\n}\n\n.tab-content[hidden] {\n    display: none;\n}\n\n.align-left {\n\tfloat: left;\n}\n.align-right {\n\tfloat: right;\n}\n\ntable .sub-list {\n    list-style: none;\n    padding-left: 0;\n}\n\ntable .key {\n    font-weight: 500;\n}\n\ntable .column {\n    width: 150px;\n}\n\ninput {\n    border: 1px solid var(--vscode-input-focus-border-color);\n    background-color: var(--vscode-input-background);\n    color: var(--vscode-input-placeholder-foreground);\n    padding: 10px;\n}\n\ninput:active {\n    color: var(--vscode-input-foreground);\n}\n\nsvg {\n    width: 20px;\n    padding-right: 5px;\n    transform: translateY(5px);\n}\n\n.save-button {\n    margin-left: 20px;\n    background-color: var(--vscode-input-background);\n    border: none;\n    padding: 2px 10px 10px 10px;\n    opacity: 0.6;\n    color: var(--vscode-editor-foreground);\n    border: 0.2px solid var(--vscode-editor-foreground);\n}\n\n.save-button:hover {\n    opacity: 1.0;\n}\n\n.search-button {\n    background: none;\n    border: none;\n    padding: 0px 10px 10px 10px;\n    opacity: 0.6;\n    color: var(--vscode-editor-foreground);\n}\n\n.search-button:hover {\n    opacity: 1.0;\n}\n\nbutton.tab {\n    border: none;\n    color: var(--vscode-editor-foreground);\n    background-color: var(--vscode-input-background);\n    padding: 10px 30px 10px 30px;\n    border: 0.2px solid var(--vscode-input-border);\n}\n\nbutton:hover { \n    color: var(--vscode-editor-foreground);\n    cursor: pointer;\n}\n\nbutton.tab[active] {\n    color: var(--vscode-editor-foreground);\n    background-color: var(--vscode-input-border);\n    border-bottom: 2px solid var(--vscode-editor-foreground);\n}\n\n#data-container {\n    max-height: 20em;\n    max-width: 100%;\n    overflow-y: scroll;\n    font-family: Menlo, Monaco, \"Courier New\", monospace;\n}\n\n.request-url {\n    opacity: 0.6;\n    padding-left: 5px;\n}\n\n.status-label {\n    padding: 2px 10px 2px 10px;\n    margin: 0 2px;\n    font-size: 1.15em;\n    font-weight: 500;\n}\n\n.status-label[statusType=\"info\"] {\n    background-color: #CCCCCC;\n    color: #333333;\n}\n.status-label[statusType=\"success\"] {\n    background-color: #CCFF99;\n    color: #006600;\n}\n.status-label[statusType=\"redirect\"] {\n    background-color: #99CCCC;\n    color: #003366;\n}\n.status-label[statusType=\"client-err\"] {\n    background-color: #FFCC66;\n    color: #663300;\n}\n.status-label[statusType=\"server-err\"] {\n    background-color: #FF9999;\n    color:#990000;\n}\n\n.search-term {\n    background-color: yellow;\n}\n\n\n@media (max-width: 800px) {\n    button.tab {\n        padding: 10px 15px 10px 15px;\n    }\n}", "",{"version":3,"sources":["webpack://./src/custom-renderer/style.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,8BAA8B;AAClC;;AAEA;IACI,aAAa;AACjB;;AAEA;CACC,WAAW;AACZ;AACA;CACC,YAAY;AACb;;AAEA;IACI,gBAAgB;IAChB,eAAe;AACnB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,wDAAwD;IACxD,gDAAgD;IAChD,iDAAiD;IACjD,aAAa;AACjB;;AAEA;IACI,qCAAqC;AACzC;;AAEA;IACI,WAAW;IACX,kBAAkB;IAClB,0BAA0B;AAC9B;;AAEA;IACI,iBAAiB;IACjB,gDAAgD;IAChD,YAAY;IACZ,2BAA2B;IAC3B,YAAY;IACZ,sCAAsC;IACtC,mDAAmD;AACvD;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,gBAAgB;IAChB,YAAY;IACZ,2BAA2B;IAC3B,YAAY;IACZ,sCAAsC;AAC1C;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,sCAAsC;IACtC,gDAAgD;IAChD,4BAA4B;IAC5B,8CAA8C;AAClD;;AAEA;IACI,sCAAsC;IACtC,eAAe;AACnB;;AAEA;IACI,sCAAsC;IACtC,4CAA4C;IAC5C,wDAAwD;AAC5D;;AAEA;IACI,gBAAgB;IAChB,eAAe;IACf,kBAAkB;IAClB,oDAAoD;AACxD;;AAEA;IACI,YAAY;IACZ,iBAAiB;AACrB;;AAEA;IACI,0BAA0B;IAC1B,aAAa;IACb,iBAAiB;IACjB,gBAAgB;AACpB;;AAEA;IACI,yBAAyB;IACzB,cAAc;AAClB;AACA;IACI,yBAAyB;IACzB,cAAc;AAClB;AACA;IACI,yBAAyB;IACzB,cAAc;AAClB;AACA;IACI,yBAAyB;IACzB,cAAc;AAClB;AACA;IACI,yBAAyB;IACzB,aAAa;AACjB;;AAEA;IACI,wBAAwB;AAC5B;;;AAGA;IACI;QACI,4BAA4B;IAChC;AACJ","sourcesContent":[".tab-bar {\n    display: flex;\n    justify-content: space-between;\n}\n\n.tab-content[hidden] {\n    display: none;\n}\n\n.align-left {\n\tfloat: left;\n}\n.align-right {\n\tfloat: right;\n}\n\ntable .sub-list {\n    list-style: none;\n    padding-left: 0;\n}\n\ntable .key {\n    font-weight: 500;\n}\n\ntable .column {\n    width: 150px;\n}\n\ninput {\n    border: 1px solid var(--vscode-input-focus-border-color);\n    background-color: var(--vscode-input-background);\n    color: var(--vscode-input-placeholder-foreground);\n    padding: 10px;\n}\n\ninput:active {\n    color: var(--vscode-input-foreground);\n}\n\nsvg {\n    width: 20px;\n    padding-right: 5px;\n    transform: translateY(5px);\n}\n\n.save-button {\n    margin-left: 20px;\n    background-color: var(--vscode-input-background);\n    border: none;\n    padding: 2px 10px 10px 10px;\n    opacity: 0.6;\n    color: var(--vscode-editor-foreground);\n    border: 0.2px solid var(--vscode-editor-foreground);\n}\n\n.save-button:hover {\n    opacity: 1.0;\n}\n\n.search-button {\n    background: none;\n    border: none;\n    padding: 0px 10px 10px 10px;\n    opacity: 0.6;\n    color: var(--vscode-editor-foreground);\n}\n\n.search-button:hover {\n    opacity: 1.0;\n}\n\nbutton.tab {\n    border: none;\n    color: var(--vscode-editor-foreground);\n    background-color: var(--vscode-input-background);\n    padding: 10px 30px 10px 30px;\n    border: 0.2px solid var(--vscode-input-border);\n}\n\nbutton:hover { \n    color: var(--vscode-editor-foreground);\n    cursor: pointer;\n}\n\nbutton.tab[active] {\n    color: var(--vscode-editor-foreground);\n    background-color: var(--vscode-input-border);\n    border-bottom: 2px solid var(--vscode-editor-foreground);\n}\n\n#data-container {\n    max-height: 20em;\n    max-width: 100%;\n    overflow-y: scroll;\n    font-family: Menlo, Monaco, \"Courier New\", monospace;\n}\n\n.request-url {\n    opacity: 0.6;\n    padding-left: 5px;\n}\n\n.status-label {\n    padding: 2px 10px 2px 10px;\n    margin: 0 2px;\n    font-size: 1.15em;\n    font-weight: 500;\n}\n\n.status-label[statusType=\"info\"] {\n    background-color: #CCCCCC;\n    color: #333333;\n}\n.status-label[statusType=\"success\"] {\n    background-color: #CCFF99;\n    color: #006600;\n}\n.status-label[statusType=\"redirect\"] {\n    background-color: #99CCCC;\n    color: #003366;\n}\n.status-label[statusType=\"client-err\"] {\n    background-color: #FFCC66;\n    color: #663300;\n}\n.status-label[statusType=\"server-err\"] {\n    background-color: #FF9999;\n    color:#990000;\n}\n\n.search-term {\n    background-color: yellow;\n}\n\n\n@media (max-width: 800px) {\n    button.tab {\n        padding: 10px 15px 10px 15px;\n    }\n}"],"sourceRoot":""}]);
// Exports
...
api.onDidCreateOutput(event => {
    ...
    (0,preact__WEBPACK_IMPORTED_MODULE_0__.render)((0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(_renderer__WEBPACK_IMPORTED_MODULE_1__.Response, { response: data, saveResponse: saveDataToFile }), event.element);
});
